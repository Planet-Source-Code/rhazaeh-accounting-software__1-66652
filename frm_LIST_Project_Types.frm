VERSION 5.00
Begin VB.Form frm_LIST_Project_Types 
   ...
   Begin VB.Frame frPrimary 
      ...
      End
      Begin VB.TextBox txtFields 
         DataField       =   "LIST PROJECT Description"
         DataSource      =   "adoPrimaryRS"
         Height          =   1245
         Index           =   1
         Left            =   840
   ...
   Begin VB.PictureBox picStatBox 
      ...
      Begin VB.CommandButton cmdLast 
         Height          =   300
         Left            =   4545
         Picture         =   "frm_LIST_Project_Types.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   12
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdNext 
         Height          =   300
         Left            =   4200
         Picture         =   "frm_LIST_Project_Types.frx":0342
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdPrevious 
         Height          =   300
         Left            =   345
         Picture         =   "frm_LIST_Project_Types.frx":0684
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdFirst 
         Height          =   300
         Left            =   0
         Picture         =   "frm_LIST_Project_Types.frx":09C6
         Style           =   1  'Graphical
         TabIndex        =   8
         Top             =   0
         UseMaskColor    =   -1  'True
   ...
   End
End
Attribute VB_Name = "frm_LIST_Project_Types"
...
On Error GoTo FormErr
  ...
  ADOprimaryrs.Open "select [LIST PROJECT Description],[LIST PROJECT Types] from [LIST Project Types]", db, adOpenStatic, adLockOptimistic
  ...
  If CheckNewDB(ADOprimaryrs, "Project Types") = True Then
    cmdAdd_Click
  End If
...
On Error GoTo FormErr
  ShowStatus True
      ...
      Set db = Nothing
  ShowStatus False
  Set frm_LIST_Project_Types = Nothing
Exit Sub
FormErr:
  MsgBox Err.Description
  ShowStatus False
