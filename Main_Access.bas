...
Dim Passwd As String
    ...
    If UserInputdata = "" Or UserInputdata = App.Path & "\properties.nos" Then
    Dim FileExist As String
        Passwd = "kucing"
        FileExist = Dir(App.Path & "\properties.nos")
        If FileExist = "" Then
            MsgBox "Someone has deleted properties.nos, the basic file." & vbCr & "Request the file from TBS. The application will stop executing", vbCritical, "Critical Error"
            End
        End If
        gblBasicADOProvider = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & _
        App.Path & "\properties.nos" & ";Jet OLEDB:Database Password=" & Passwd & ";Admin"
...
'Dim FileExist As String
    ...
    'Passwd = "kucing"
    'gblBasicADOProvider = App.Path & "\properties.nos"
    DbConnectionString ""
...
Dim SQLstatement As String
  ...
  'cnn.Open "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & App.Path & "\properties.nos" & ";Persist Security Info=False"
