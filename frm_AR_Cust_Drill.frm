...
Begin VB.Form frm_AR_Cust_Drill 
   ...
   Begin VB.PictureBox picStatBox 
      ...
      Begin VB.CommandButton cmdFirst 
         Height          =   300
         Left            =   0
         Picture         =   "frm_AR_Cust_Drill.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   7
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdPrevious 
         Height          =   300
         Left            =   345
         Picture         =   "frm_AR_Cust_Drill.frx":0342
         Style           =   1  'Graphical
         TabIndex        =   6
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdNext 
         Height          =   300
         Left            =   4200
         Picture         =   "frm_AR_Cust_Drill.frx":0684
         Style           =   1  'Graphical
         TabIndex        =   5
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdLast 
         Height          =   300
         Left            =   4545
         Picture         =   "frm_AR_Cust_Drill.frx":09C6
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   0
         UseMaskColor    =   -1  'True
   ...
   Begin MSDataGridLib.DataGrid grdDataGrid 
      Align           =   1  'Align Top
      Bindings        =   "frm_AR_Cust_Drill.frx":0D08
      Height          =   3495
      Left            =   0
      TabIndex        =   9
      Top             =   0
   ...
   End
End
Attribute VB_Name = "frm_AR_Cust_Drill"
...
On Error GoTo FormErr
  ...
  sql = "select [AR SALE Date],[AR SALE Document Type],[AR SALE Ext Document #]," & _
    "[AR SALE Total] from [AR Sales]"
  SQLW = "where [AR SALE Customer ID] = '" & frm_AR_Customer.txtfields(0).Text & "'"
  SQLState = sql & SQLW
