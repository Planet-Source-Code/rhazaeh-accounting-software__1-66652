...
Begin VB.Form frm_AR_Cash_Receipts 
   Caption         =   "Cash Receipts"
   ClientHeight    =   7845
   ClientLeft      =   2070
   ClientTop       =   2715
   ClientWidth     =   12645
   Icon            =   "frm_AR_Cash_Receipts.frx":0000
   KeyPreview      =   -1  'True
   LinkTopic       =   "Form1"
   MDIChild        =   -1  'True
   ScaleHeight     =   7845
   ...
   Begin VB.Frame frPrimary 
      ...
      Begin VB.Frame frPanel 
         ...
         Begin VB.CommandButton cmdClose 
            ...
            Height          =   375
            Left            =   2160
            Picture         =   "frm_AR_Cash_Receipts.frx":030A
            TabIndex        =   53
            Top             =   6000
            Width           =   975
         End
         Begin VB.CommandButton cmdDel 
            ...
            Height          =   375
            Left            =   1200
            Picture         =   "frm_AR_Cash_Receipts.frx":0614
            TabIndex        =   54
            Top             =   6000
            Width           =   975
         End
         Begin VB.CommandButton cmdPost 
            ...
            Height          =   855
            Left            =   2160
            Picture         =   "frm_AR_Cash_Receipts.frx":091E
            Style           =   1  'Graphical
            TabIndex        =   55
            Top             =   5040
            Width           =   975
         ...
         Begin VB.CommandButton cmdNSF 
            ...
            Height          =   855
            Left            =   1200
            Picture         =   "frm_AR_Cash_Receipts.frx":0C28
            Style           =   1  'Graphical
            TabIndex        =   56
            Top             =   5040
            Width           =   975
         ...
         Begin VB.CommandButton cmdPrint 
            ...
            Height          =   855
            Left            =   240
            Picture         =   "frm_AR_Cash_Receipts.frx":0F32
            Style           =   1  'Graphical
            TabIndex        =   65
         ...
         Begin VB.CommandButton cmdApply 
            ...
            Height          =   375
            Left            =   240
            Picture         =   "frm_AR_Cash_Receipts.frx":123C
            TabIndex        =   57
            Top             =   6000
            Width           =   975
         End
      ...
      Begin VB.CommandButton cmdCashCustomer 
         Height          =   285
         Left            =   3120
         Picture         =   "frm_AR_Cash_Receipts.frx":1546
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   840
         Width           =   375
      ...
      Begin VB.CommandButton cmdCheckNo 
         ...
         Height          =   285
         Left            =   3120
         Picture         =   "frm_AR_Cash_Receipts.frx":1850
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   1560
         Width           =   375
      ...
      Begin VB.CommandButton cmdbankAccount 
         Height          =   285
         Left            =   3120
         Picture         =   "frm_AR_Cash_Receipts.frx":1B5A
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   2640
         Width           =   375
   ...
   Begin VB.PictureBox picStatBox 
      ...
      Begin VB.CommandButton cmdLast 
         Height          =   300
         Left            =   4545
         Picture         =   "frm_AR_Cash_Receipts.frx":1E64
         Style           =   1  'Graphical
         TabIndex        =   4
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdNext 
         Height          =   300
         Left            =   4200
         Picture         =   "frm_AR_Cash_Receipts.frx":21A6
         Style           =   1  'Graphical
         TabIndex        =   3
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdPrevious 
         Height          =   300
         Left            =   345
         Picture         =   "frm_AR_Cash_Receipts.frx":24E8
         Style           =   1  'Graphical
         TabIndex        =   2
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdFirst 
         Height          =   300
         Left            =   0
         Picture         =   "frm_AR_Cash_Receipts.frx":282A
         Style           =   1  'Graphical
         TabIndex        =   1
         Top             =   0
         UseMaskColor    =   -1  'True
   ...
   End
End
Attribute VB_Name = "frm_AR_Cash_Receipts"
...
'On Error GoTo PostData_Error
  ...
  rsWork.Open "SELECT [Reference],[Applied Amount],[Balance],[Discount],[Write Off] " & _
  "FROM [Cash Receipts Work]", db, adOpenKeyset, adLockOptimistic, adCmdText
'  rsWork.Open "SELECT * FROM [Cash Receipts Work]", db, adOpenKeyset, adLockOptimistic
  ...
  rsSales.Open "SELECT [AR SALE Total],[AR SALE Amount Paid],[AR SALE Balance Due]," & _
  "[AR SALE Document #],[AR SALE Ext Document #] FROM [AR Sales]", db, adOpenKeyset, adLockOptimistic
...
Exit Sub
PostData_Error:
  Call ErrorLog("Cash Receipts", "PostData", Now, Err.Number, Err.Description, True, db)
End Sub
...
'  rsWork.Open "SELECT * FROM [Cash Receipts Work]", db, adOpenStatic, adLockOptimistic
  ...
  Set rsSales = New ADODB.Recordset
  rsSales.Open "SELECT [AR SALE Amount Paid],[AR SALE Balance Due],[AR SALE Document #]," & _
  "[AR SALE Ext Document #] FROM [AR Sales]", db, adOpenKeyset, adLockOptimistic, adCmdText
...
Set rsWork = Nothing
  ...
  Exit Sub
PostDataNSF_Error:
  Call ErrorLog("Cash Receipts", "PostDataNSF", Now, Err.Number, Err.Description, True, db)
  Resume Next
...
'  On Error GoTo PostNSF_Error
  ...
  "[SYS COM Sales Write Off Acct],[SYS COM GL Post By Date] " & _
  "FROM [SYS Company]", db, adOpenStatic, adLockOptimistic
  rsCompany.MoveFirst
  
  'Dim rsGLWorkDetailTemp As ADODB.Recordset
  'Set rsGLWorkDetailTemp = New ADODB.Recordset
  ...
  '
  rsCustomer.Open "SELECT [AR CUST Customer ID],[AR CUST Name],[AR CUST Payments YTD]," & _
  "[AR CUST Payments Lifetime],[AR CUST Financial Period 1] FROM [AR Customer] " & _
  "WHERE [AR CUST Customer ID]='" & txtfields(0).Text & "'", db, adOpenKeyset, adLockOptimistic, adCmdText
...
'again:
  ...
  rsCross.Open "SELECT [AR CROSS Applied Amount], [AR CROSS Discount Taken],[AR CROSS Write Off Amount]," & _
  "[AR CROSS Payed ID] FROM [AR Payment Invoice Cross Reference] WHERE " & _
  "[AR CROSS Payment ID] = " & txtfields(2), db, adOpenKeyset, adLockOptimistic, adCmdText
...
PostNSF_Error:
  Call ErrorLog("Cash Receipts", "PostNSF", Now, Err.Number, Err.Description, True, db)
  PostNSF = False
  Exit Function
  Resume Next
...
AR_PostPayments_Error:
  Call ErrorLog("Cash Receipts", "AR_PostPayments", Now, Err.Number, Err.Description, True, db)
  AR_PostPayments% = False
  Exit Function
  'Resume Next
...
AR_PAY_Check_No_AfterUpdate_Error:
  Call ErrorLog("Cash Receipts", "CheckAllData", Now, Err.Number, Err.Description, True, db)
  Resume Next
...
AR_PAY_Check_No_BeforeUpdate_Error:
  Call ErrorLog("Cash Receipts", "AR_PAY_Check_No_BeforeUpdate", Now, Err.Number, Err.Description, True, db)
  Resume Next
...
Private Sub grdDataGridSource(SQLstatement As String)
  ...
  Set adoPrimaryRS2 = New ADODB.Recordset
    ...
    If adoPrimaryRS2.RecordCount > 0 Then
       ...
       Loop
          TotalDue = FormatCurr(Balance)
          TotalApplied = FormatCurr(AppliedAmt)
    End If
...
Private Sub cmdPost_Click()
  ...
  txtfields(7) = AcctBalance("balance", txtfields(1).Text, db)
...
cmdPost_Click_Error:
  Call ErrorLog("Cash Receipts", "cmdPost_Click", Now, Err.Number, Err.Description, True, db)
  Resume Next
End Sub
...
Datavalidate = True
  ...
  Exit Function
DataValidate_Error:
  Call ErrorLog("Cash Receipts", "DataValidate", Now, Err.Number, Err.Description, True, db)
  Resume Next
...
Private Sub cmdbankAccount_Click()
    ...
    If txtfields(1) <> "" Then
        ...
        txtfields(7) = AcctBalance("balance", txtfields(1).Text, db)
        'txtFields(7) = NZ(LookRecord("[GL COA Account Balance]", "[GL Chart Of Accounts]", "[GL COA Account No] = '" & txtFields(1).Text & "'"))
...
'Dim tempStr As String
   ...
   "Check No//Customer ID//Payment type//Transaction Date//Amount", db
...
Private Sub cmdNSF_Click()
  ...
  If txtfields(6) = "Credit Memo" Then
    MsgBox "Can't mark a Credit Memo NSF!", , "Information"
    ShowStatus False
    Exit Sub
  End If
  If chkFields(9).Value <> 1 Then
    MsgBox "This transaction is not posted yet. Please use delete button", , "Information"
    ShowStatus False
    Exit Sub
  End If
  
  If ADOprimaryrs![AR PAY NSF] = True Then
    MsgBox "This transaction already mark as NSF", , "Information"
    ShowStatus False
    Exit Sub
  End If
  ...
  db.BeginTrans
    ...
    Else
      ...
      ADOprimaryrs![AR PAY Status] = "NSF"
...
cmdNSF_Click_Error:
  Call ErrorLog("Cash Receipts", "cmdNSF_Click", Now, Err.Number, Err.Description, True, db)
  Resume Next
...
Private Sub cmdApply_Click()
  ...
  If cmdApply.Caption = "&Save" Then
    'db.BeginTrans
    'ADOprimaryrs![AR PAY Status] = "Save"
    'ADOprimaryrs.Update
    ...
    Case 0, 1, 4, 5
      If i = 4 Then
        If txtfields(i) = "$0.00" Then
          ...
          Exit Sub
        End If
        If CCur(txtfields(4).Text) > CCur(TotalDue.Text) Then
            MsgBox "Amount recieved is bigger compare to Total Due", vbInformation, "Information"
            ShowStatus False
            Exit Sub
        End If
      Else
...
cmdApply_Click_Error:
  Call ErrorLog("Cash Receipts", "cmdApply_Click", Now, Err.Number, Err.Description, True, db)
  Resume Next
...
'  Exit Sub
'RedoNumbers_Error:
'  Call ErrorLog("Cash Receipts", "RedoNumbers", Now, Err.Number, Err.Description, True, db)
'  Resume Next
...
'maybe we could join this with PostData Module == almost alike
  ...
  Set rsSales = New ADODB.Recordset
  rsSales.Open "SELECT [AR SALE Total],[AR SALE Amount Paid],[AR SALE Balance Due]," & _
  "[AR SALE Document #],[AR SALE Ext Document #],[AR SALE Date] FROM [AR Sales]", db, adOpenKeyset, adLockOptimistic
  ...
  txtfields(12).Text = FormatCurr(CCur(TotalAppliedCurr#))
  Exit Sub
RefreshData_Error:
  Call ErrorLog("Cash Receipts", "RefreshData", Now, Err.Number, Err.Description, True, db)
  Resume Next
...
Private Sub RebuildTable()
  ...
  If NoCheck% = False Then
    ...
    'Set rsCashReceipts = New ADODB.Recordset
    Dim FoundCashReceipt As Boolean
    FoundCashReceipt = CheckDocument("SELECT * FROM [AR Payment Header] WHERE [AR PAY Customer No]='" & txtfields(0) & "' AND [AR PAY Check No]='" & txtfields(5) & "'", db, False)
  ...
  If NoCheck% = True Then
    ...
    Set rsSales = New ADODB.Recordset
    rsSales.Open "SELECT [AR SALE Total],[AR SALE Amount Paid],[AR SALE Balance Due]," & _
    "[AR SALE Document #],[AR SALE Ext Document #],[AR SALE Date] FROM [AR Sales]" & _
    "where [AR SALE Posted YN] = True and [AR SALE Balance Due] >= .01 and " & _
    "[AR SALE Customer ID] = '" & txtfields(0) & "' AND [AR SALE Document Type] in " & _
    "('Invoice','Sales Memo','Beginning Balance','Finance Charge')", db, adOpenKeyset, adLockOptimistic
    'rsSales.Open "SELECT * FROM [AR Sales] where [AR SALE Posted YN] = True and [AR SALE Balance Due] >= .01 and [AR SALE Customer ID] = '" & txtFields(0) & "' AND [AR SALE Document Type] in ('Invoice','Sales Memo','Beginning Balance','Finance Charge')", db, adOpenKeyset, adLockOptimistic
    
    Set rsWork = New ADODB.Recordset
    'rsWork.Open "[Cash Receipts Work]", db, adOpenKeyset, adLockOptimistic, adCmdTable
    rsWork.Open "SELECT [Date],[Reference],[Applied Amount],[Balance],[Discount],[Write Off]," & _
    "[Original Amount],[Amount Paid] FROM [Cash Receipts Work]", db, adOpenKeyset, adLockOptimistic, adCmdText
    'On Error Resume Next
    'GoTo back:
  ...
  Else
    ...
    rsSales.Open "SELECT [AR SALE Total],[AR SALE Amount Paid],[AR SALE Balance Due]," & _
    "[AR SALE Document #],[AR SALE Ext Document #],[AR SALE Date] FROM [AR Sales]" & _
    "where [AR SALE Posted YN] = True and [AR SALE Customer ID] = '" & _
    txtfields(0) & "' AND [AR SALE Document Type] in ('Invoice','Sales Memo','Beginning Balance','Finance Charge')", db, adOpenKeyset, adLockOptimistic
    'rsSales.Open "SELECT * FROM [AR Sales] where [AR SALE Posted YN] = True and [AR SALE Customer ID] = '" & txtFields(0) & "' AND [AR SALE Document Type] in ('Invoice','Sales Memo','Beginning Balance','Finance Charge')", db, adOpenKeyset, adLockOptimistic
    
    Set rsCross = New ADODB.Recordset
    'rsCross.Open "SELECT * FROM [AR Payment Invoice Cross Reference] WHERE [AR CROSS Payment ID]=" & txtFields(2).Text, db, adOpenKeyset, adLockOptimistic, adCmdText
    rsCross.Open "SELECT [AR CROSS Applied Amount], [AR CROSS Discount Taken],[AR CROSS Write Off Amount]," & _
    "[AR CROSS Payed ID] FROM [AR Payment Invoice Cross Reference] WHERE " & _
    "[AR CROSS Payment ID] = " & txtfields(2), db, adOpenKeyset, adLockOptimistic, adCmdText
    ...
    'If Err = 0 Then
      ...
      Do While Not rsSales.EOF '<<<-----------------------------------------
        ...
        If rsSales("AR SALE Balance Due") = 0 Then
          ...
          If rsCross.RecordCount = 0 Then GoTo SkipIt
          rsCross.MoveFirst
...
SkipIt:
  ...
  Exit Sub
RebuildTable_Error:
  Call ErrorLog("Cash Receipts", "RebuildTable", Now, Err.Number, Err.Description, True, db)
  Resume Next
...
Private Sub cmdDelete_Click()
     If Not DataDelete(ADOprimaryrs, Me, False) Then
     End If
End Sub
...
Select Case Index
Case 5
     If IsNumeric(txtfields(Index)) Or txtfields(5) = "" Then
        If Index = 5 Then
     ...
     Else
        If txtfields(Index) <> "" Then
            MsgBox "Only Numeric Character accepted", vbInformation, "Information"
        End If
        If ADOprimaryrs Is Nothing Then
        Else
            ADOprimaryrs.CancelUpdate
            If txtfields(5) <> "" Then
                txtfields(4) = FormatCurr(ADOprimaryrs![AP PAY Amount])
                txtfields(5) = ADOprimaryrs![AP PAY Check No]
            End If
        End If
     End If
Case 14
     If ADOprimaryrs Is Nothing Then Exit Sub
     If ADOprimaryrs.EditMode <> adEditAdd Then
        ADOprimaryrs.Update
     End If
End Select
